package com.hookedroid.chromecastdemo.logging;
 ...
 */
public final class VideoEventLogger implements Player.EventListener, AudioRendererEventListener,
    ...
    public VideoEventLogger(MappingTrackSelector trackSelector) {
